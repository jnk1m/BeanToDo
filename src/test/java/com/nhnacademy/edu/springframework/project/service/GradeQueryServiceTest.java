...
class GradeQueryServiceTest {
    ...
    void getScoreByStudentName() {
        ...
        List<Score> scoreByStudentName = defaultGradeQueryService.getScoreByStudentName(studentList.get(0).getName());
        Assertions.assertThat(scoreByStudentName).isEqualTo(List.of(studentList.get(0).getScore()));
