...
class StudentsTest {
   ...
   void load() throws NoSuchFieldException, IllegalAccessException {
      ...
      List<Student> studentList = (List<Student>) field.get(csvStudents);
   ...
   void findAll() throws NoSuchFieldException, IllegalAccessException {
      ...
      field.set(csvStudents,studentList);

      Collection<Student> all = csvStudents.findAll();
   ...
   void merge() throws NoSuchFieldException, IllegalAccessException {
      ...
      csvStudents.merge(scoreList);

      List<Student> finalStudentList = (List<Student>)field.get(csvStudents);
